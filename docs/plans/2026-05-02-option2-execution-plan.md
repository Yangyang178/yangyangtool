...
| 阶段 | 任务 | 工时 | 优先级 | 风险 | 状态 |
|------|------|------|--------|------|------|
| **A. 样式基础** | A1: 公共样式系统提取 | 2.5h | P0 | 🟢 极低 | ⏳ 待开始 |
| **A. 样式基础** | A2: 设计令牌定义 | 1h | P0 | 🟢 极低 | ⏳ 待开始 |
| **B. 首页完善** | B1: Hero Section 增强 | 2.5h | P0 | 🟢 低 | ⏳ 待开始 |
| **B. 首页完善** | B2: 动效系统完善 | 1.5h | P1 | 🟢 低 | ⏳ 待开始 |
| **B. 首页完善** | B3: 搜索框交互增强 | 1h | P1 | 🟢 低 | ⏳ 待开始 |
| **C. 工具统一** | C1: 汇率换算 | 1.5h | P0 | 🟢 低 | ⏳ 待开始 |
| **C. 工具统一** | C2: 单位换算 | 1.5h | P0 | 🟢 低 | ⏳ 待开始 |
| **C. 工具统一** | C3: 房贷计算器 | 1.5h | P0 | 🟢 低 | ⏳ 待开始 |
| **C. 工具统一** | C4: 小费计算器 | 1h | P0 | 🟢 低 | ⏳ 待开始 |
| **C. 工具统一** | C5: BMI计算器 | 1.5h | P0 | 🟢 低 | ⏳ 待开始 |
| **C. 工具统一** | C6: 个税计算器 | 1.5h | P0 | 🟢 低 | ⏳ 待开始 |
| **C. 工具统一** | C7: 年龄计算器 | 1.5h | P0 | 🟢 低 | ⏳ 待开始 |
| **D. 收尾验收** | D1: 全面测试 | 1h | P0 | 🟢 极低 | ⏳ 待开始 |
| **D. 收尾验收** | D2: Git标签与文档 | 0.5h | P0 | 🟢 极低 | ⏳ 待开始 |
| **总计** | **13个任务** | **~19h** | - | - | - |
